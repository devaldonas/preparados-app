// lib/descricoesMochila.ts

// 🔥 MAPEAMENTO COMPLETO DAS DESCRIÇÕES DOS ITENS
// Extraído do PDF do Guia da Mochila
export const descricoesMochila: Record<string, string> = {
  ...
  'Rede armadeira': 'Rede compacta de descanso que mantém o corpo afastado do chão e pode integrar um sistema de abrigo, conforme o modelo.',
  ...
  'Termômetro': 'Verifica temperatura corporal, auxiliando na identificação de febre ou hipotermia.',
  'Toalhas de álcool': 'Higienizam a pele antes de procedimentos ou limpeza de pequenos ferimentos.',
  'Pinça': 'Auxilia na remoção de farpas, ciscos ou pequenos objetos de ferimentos.',
  'Cortador': 'Corta curativos, esparadrapo, fita e materiais diversos com segurança.',
  'Chás para resfriado': 'Ajudam no alívio de sintomas leves de resfriado e proporcionam conforto térmico.',
  'Fio de sutura': 'Material para fechamento de ferimentos que exige treinamento. Não deve ser usado sem capacitação.',
  'Lâmina de bisturi': 'Ferramenta cortante para procedimentos específicos que exige treinamento e cuidado extremo.',
  ...
  'Hidratante labial': 'Protege os lábios contra ressecamento, rachaduras e exposição ao sol e vento.',
  'Benegrip': 'Alivia sintomas de gripe e resfriado, como febre, dor de cabeça e congestão.',
  'Spray anti-séptico': 'Higieniza ferimentos e superfícies, prevenindo infecções.',
  'Álcool gel': 'Higieniza as mãos quando não há água e sabão disponíveis.',
  'Soro fisiológico': 'Lava ferimentos, olhos e mucosas, mantendo a área limpa.',
  'Pomada Minâncora': 'Alivia coceiras, picadas de inseto e pequenas irritações da pele.',
  'Iodo': 'Anti-séptico para higienização de ferimentos e desinfecção de água (se apropriado).',
  'Alivium': 'Analgésico para dores musculares e inflamações, conforme orientação médica.',
  
  // === KIT HIGIENE ===
  'Papel higiênico': 'Mantém a higiene pessoal em locais sem infraestrutura.',
  'Lenços umedecidos': 'Permitem limpeza rápida das mãos e do corpo quando não há água disponível.',
  'Lenços de papel': 'Úteis para limpeza geral, absorção e higiene básica.',
  'Cortador de unha': 'Mantém as unhas aparadas, prevenindo acidentes e facilitando a higiene.',
  'Barbeador': 'Permite manutenção da barba e higiene pessoal durante deslocamentos prolongados.',
  ...
  'Escova': 'Solta resíduos de superfícies, ranhuras e peças de difícil acesso.',
  'Cordão passador': 'Conduz pano ou escova por tubos e espaços estreitos durante a limpeza de equipamentos.',
  'Óleo': 'Lubrifica e protege superfícies metálicas contra atrito e corrosão, desde que seja o produto recomendado pelo fabricante.',
  
  // === KIT PESCA ===
  'Anzóis': 'Prendem a isca e permitem fisgar o peixe; devem ser transportados em embalagem rígida.',
  'Chumbada': 'Adiciona peso para levar a linha e a isca à profundidade desejada.',
  'Linha': 'Conecta a vara ou o suporte ao anzol e aos demais componentes.',
  'Boia': 'Mantém a isca em determinada profundidade e sinaliza movimentação ou mordida.',
  'Isca': 'Atrai o peixe, podendo ser natural ou artificial.',
  'Empate': 'Trecho reforçado entre a linha e o anzol, útil contra abrasão, dentes ou rompimentos.',
  'Rede': 'Auxilia na captura ou retirada do peixe da água. O uso deve respeitar as regras locais de pesca.',
  
  // === KIT COSTURA ===
  '2 botões': 'Substituem botões perdidos em roupas, bolsas e equipamentos.',
  '2 agulhas': 'Permitem pequenos reparos em tecidos, costuras e acessórios.',
  '1 carretel de linha': 'Fornece material para costurar rasgos, fixar botões e fazer amarrações leves.',
  '2 joaninhas': 'Pequenos alfinetes de segurança usados para prender provisoriamente tecidos, faixas ou peças soltas.',
  
  // === KIT VARIÁVEL ===
  'Bússola': 'Ajuda a determinar direção e orientação quando usada junto com um mapa e conhecimento básico de navegação.',
  'Faca lâmina integral': 'Ferramenta robusta para corte e tarefas gerais. Deve ser transportada com bainha, usada com segurança e respeitar a legislação local.',
  'Canivete': 'Ferramenta compacta para cortes leves, abertura de embalagens e pequenos reparos.',
  'Mosquetão': 'Organiza e prende objetos leves à mochila. Não deve ser usado para escalada ou sustentação humana sem certificação específica.',
  'Paracord': 'Corda resistente para amarrações, reparos, montagem de abrigo e organização de carga.',
  'Afiador de faca': 'Mantém a capacidade de corte das lâminas e reduz a força necessária durante o uso.',
  'Cintas plásticas': 'Fazem fixações rápidas, agrupam cabos e ajudam em reparos temporários.',
  'Fita isolante': 'Isola conexões elétricas simples e auxilia em reparos provisórios e fixações.',
  'Apito': 'Produz sinal sonoro forte para pedir ajuda ou indicar localização com pouco gasto de energia.',
  'Boné': 'Protege rosto e olhos do sol e ajuda a reduzir a incidência direta de luz.',
  'Binóculo': 'Permite observar rotas, obstáculos, pessoas e pontos de referência à distância.',
  'Sacos BGS impermeáveis': 'Protegem e separam roupas, documentos, alimentos ou equipamentos da umidade.',
  'Caneta e bloco para anotações': 'Permitem registrar contatos, rotas, horários, recados, inventário e informações importantes.',
  'Sinalizador laser': 'Pode servir como sinal visual à distância, mas nunca deve ser apontado para olhos, pessoas, veículos ou aeronaves.',
  'Velas': 'Fornecem iluminação e uma pequena fonte de chama. Devem ficar em base firme, longe de materiais inflamáveis e nunca sem supervisão.',
}

// 🔥 FUNÇÃO PARA BUSCAR DESCRIÇÃO POR NOME
export function getDescricaoItem(nome: string): string | undefined {
  // Busca exata pelo nome
  if (descricoesMochila[nome]) {
    return descricoesMochila[nome]
  }
  
  // Busca ignorando caracteres especiais (parênteses, etc)
  const nomeLimpo = nome.replace(/[\(\)]/g, '').trim()
  for (const [key, value] of Object.entries(descricoesMochila)) {
    const keyLimpo = key.replace(/[\(\)]/g, '').trim()
    if (keyLimpo === nomeLimpo) {
      return value
    }
  }
