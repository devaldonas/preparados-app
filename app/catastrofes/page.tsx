            ...
            <div className="space-y-6">
              ...
              <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                ...
                <ul className="list-disc list-inside text-gray-700 space-y-1">
                  ...
                  <li>⚠️ Evitar bebidas alcoólicas (inibem a termorregulação), reduzindo a capacidade do organismo se regular, reagir às baixas temperaturas.</li>
                  <li>Cuidado com desidratação: O frio atenua a sensação de sede, dessa forma não bebemos água suficiente. Desidratação, é algo silencioso, pois perdemos liquido no vapor que sai da nossa boca, e acabamos não percebendo em situação de extremo frio</li>
                </ul>
              </div>
              ...
              <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                ...
                <p className="text-gray-700 mb-3">
                  ...
                  Em uma das últimas mensagens de uma alpinista, ela relatou que estava sem força para apertar o botão
