...
export default function Catastrofes() {
  ...
  const abas = [
    { id: 'terremoto', nome: 'Terremoto', icone: '/images/catastrofes/terremoto.jpeg' },
    { id: 'tsunami', nome: 'Tsunami', icone: '/images/catastrofes/tsunami.jpeg' },
    { id: 'rotas', nome: 'Rotas de Fuga', icone: '/images/catastrofes/rotadefuga.png' },
    { id: 'defesa', nome: 'Preparação para Frio Extremo', icone: '/images/catastrofes/frioextremo.jpeg' },
  ]
  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-20">
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="mb-6">
          <div className="relative">
            <button
              ...
              className="w-full bg-white border border-gray-200 rounded-xl px-4 py-3 flex items-center justify-between gap-2 shadow-sm hover:bg-gray-50 transition"
            >
              <div className="flex items-center gap-3">
                ...
                />
                <span className="font-medium text-gray-700">{abaAtual?.nome}</span>
              </div>
              <span className={`text-gray-400 transition-transform ${menuAberto ? 'rotate-180' : ''}`}>▼</span>
            </button>
        ...
        {/* PREPARAÇÃO PARA FRIO EXTREMO (COMPLETO) */}
        {abaAtiva === 'defesa' && (
          <div className="space-y-6">
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-4">
                ...
                <img src="/images/catastrofes/isolantes-slide3.png" alt="Isolante 3" className="rounded-lg border" />
                <img src="/images/catastrofes/isolantes-slide4.png" alt="Isolante 4" className="rounded-lg border" />
                <img src="/images/catastrofes/isolantes-slide5.png" alt="Isolante 5" className="rounded-lg border" />
                <img src="/images/catastrofes/isolantes-slide6.png" alt="Isolante 6" className="rounded-lg border" />
                <img src="/images/catastrofes/isolantes-slide7.png" alt="Isolante 7" className="rounded-lg border" />
                <img src="/images/catastrofes/isolantes-slide8.png" alt="Isolante 8" className="rounded-lg border" />
              </div>
              <ul className="list-disc list-inside text-gray-700 space-y-1">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-3 mb-4">
                ...
                <img src="/images/catastrofes/alimentos-slide3.png" alt="Alimento" className="rounded-lg border" />
                <img src="/images/catastrofes/alimentos-slide4.png" alt="Alimento" className="rounded-lg border" />
                <img src="/images/catastrofes/alimentos-slide5.png" alt="Alimento" className="rounded-lg border" />
              </div>
              <ul className="list-disc list-inside text-gray-700 space-y-1">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
              ...
              <img src="/images/catastrofes/deslocamento-frio-slide1.png" alt="Deslocamento" className="rounded-lg w-full mb-4 border" />
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-3 mb-4">
                ...
                <img src="/images/catastrofes/cozinhar-slide3.png" alt="Cozinhar" className="rounded-lg border" />
              </div>
