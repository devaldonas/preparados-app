          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="border-t border-gray-100 pt-4">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-[#FFB800] hover:bg-[#E5A600] text-black font-display font-bold py-3 rounded-lg transition-colors disabled:opacity-50 flex items-center justify-center gap-2"
              >
                {loading ? (
                  <>
